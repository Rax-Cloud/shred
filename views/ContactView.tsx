  ...
  return (
    <div className={`min-h-screen ${THEME.colors.background}`}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-1 gap-16"> {/*md:grid-cols-2 - faq jaoks*/}
          <div>
              ...
              <div>
                ...
                <div className="flex gap-4">
                  ...
                  <a target="_blank" href="https://www.tiktok.com/@ofshred?_r=1&_t=ZN-93TGDnusLqw" className="underline underline-offset-4 hover:text-blue-600">Facebook</a>
                    <a target="_blank" href="https://www.tiktok.com/@ofshred?_r=1&_t=ZN-93TGDnusLqw" className="underline underline-offset-4 hover:text-blue-600">TikTok</a>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-gray-50 p-8 sm:p-12 h-full flex flex-col justify-center items-start">
             ...
             <ul className="space-y-6">
                <li>
                  <strong className="block text-sm uppercase mb-1">Tellimused välisriiki?</strong>
                  <p className="text-sm text-gray-600"></p>
                </li>
                <li>
                  <strong className="block text-sm uppercase mb-1">Kaua tellimuse kätte saamiseks?</strong>
                  <p className="text-sm text-gray-600"></p>
                </li>
                <li>
                  <strong className="block text-sm uppercase mb-1">Tagastus?</strong>
                  <p className="text-sm text-gray-600"></p>
                </li>
             </ul>
          </div>
